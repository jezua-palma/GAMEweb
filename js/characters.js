...
const Characters = (() => {
    ...
    const DEFS = {
        warrior: {
            ...
            description: 'Devastating melee fighter. Highest damage output but fragile. Active Cleave skill triggers via Active Skill key (default Q).',
        ...
        paladin: {
            ...
            description: 'Unbreakable holy tank. Highest HP and armor with HP regeneration. Active Holy Bastion skill triggers via Active Skill key (default Q).',
